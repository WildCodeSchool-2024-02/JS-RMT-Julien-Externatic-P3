      ...
      <div className="main-home-page">
        <article className="container-presentation">
          <p>
            ...
            <br />
            Nulla exercitationem reprehenderit saepe sit veritatis ex minima
            porro totam illum tenetur! Ipsa ipsam explicabo distinctio nisi
        ...
        <article className="container-presentation">
          ...
          <p>
            ...
            minima porro totam illum tenetur! Ipsa ipsam explicabo distinctio
            nisi libero? Laudantium ducimus omnis ut cumque accusantium
            molestias quisquam, minima inventore, veniam fugit iste eaque! In
            quo minima accusamus? Eveniet, tempore repellendus quaerat tempora
            natus non nostrum hic dolores. Temporibus, optio! Autem dignissimos
            commodi provident dolorum incidunt perspiciatis nesciunt distinctio
            ullam, debitis dicta
          </p>
        </article>
